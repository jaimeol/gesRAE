...
int	check_name_len(TypeString str)
{
	if (strlen(str) > 20)
	{
		printf("Error: Tamaño de nombre demasiado largo.\n");
		printf("Por favor vuelva introducir el nombre\n");
		return (1);
	}
	else if (strlen(str) < 1)
	{
		printf ("El nombre debe de estar conformado de al menos un caracter\n");
		printf("Por favor vuelva introducir el nombre\n");
		return (1);
	}
	return (0);
...
int	check_total_apartments(TypeBuilding buildings, int id)
{
	...
	{
		printf ("\033[31mError\033[0m: Solo puede haber un máximo de 20 apartamentos\n");
